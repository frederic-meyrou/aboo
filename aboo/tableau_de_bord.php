...
<body>    
    ...
    <?php $page_courante = "tableau_de_bord.php"; require 'nav.php'; ?>
            
    <div class="container">
        <div class="page-header">          
            <h2>Tableau de bord exercice : <button type="button" class="btn btn-lg btn-info"><?php echo "$exercice_annee - " . ($exercice_annee +1); ?></button></h2>
        </div>
